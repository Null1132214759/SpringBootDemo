package com.edu.dao.implProvider;

import com.edu.entity.User;
import com.edu.entity.UserExample.Criteria;
import com.edu.entity.UserExample.Criterion;
...
public class UserSqlProvider {
    ...
    public String insertSelective(User record) {
        ...
        if (record.getAuthority() != null) {
            sql.VALUES("authority", "#{authority,jdbcType=INTEGER}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getAuthority() != null) {
            sql.SET("authority = #{record.authority,jdbcType=INTEGER}");
        }
    ...
    public String updateByPrimaryKeySelective(User record) {
        ...
        if (record.getAuthority() != null) {
            sql.SET("authority = #{authority,jdbcType=INTEGER}");
        }
